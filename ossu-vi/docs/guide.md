...
:-- | :--: | :--: | :--: | :--:
[Introduction to programming]() | 10 weeks | 10 hours/week | none | [chat](https://discord.gg/syA242Z)
...
Courses | Duration | Effort | Prerequisites | Discussion
:-- | :--: | :--: | :--: | :--:
[Introduction to Computer Science and Programming using Python]() | 9 weeks | 15 hours/week | [high school algebra](https://www.khanacademy.org/math/algebra-home) | [chat](https://discord.gg/jvchSm9)
...
_Trừ khóa đầu tiên ra thì các khóa còn lại đều có Vietsub. Enjoy!_
...
_Ghi chú: Không có Tiếng Việt, nhưng cũng có nhiều khóa nội dung tương tự dạy trên Youtube, sẽ bổ sung sau._
...
Courses | Duration | Effort | Prerequisites | Discussion
:-- | :--: | :--: | :--: | :--:
[Kì Học Bị Thiếu Của Giáo Trình Khoa Học Máy Tính](https://missing-semester-vn.github.io/) | 2 weeks | 12 hours/week | - | [chat](https://discord.gg/5FvKycS)
